...
function PANEL:GetCirclePos()
    local w, h = self:GetSize()
    return math.Clamp( self.shown_percentage * w, h, w ) - self.circle_radius, h / 2
end
...
vgui.Register( "GNProgress", PANEL, "DPanel" )
